                        ...
                        <Col lg={12} className="flex items-center flex-wrap flex-col">
                            <Col lg={3} className="flex items-center justify-center flex-col w-full">
                                <div className="w-full">
                                    ...
                                    <div className="relative w-full">
                                        <input type="file" id="file-upload" required className="hidden" onChange={handleImage} />
                            ...
                            <Col xs={12} sm={12} md={12} lg={12}>
                                <div className="mb-4">
                                    ...
                                    <input type="text" required  pattern="[A-Za-z ]{2,}" name="title" value={formInput.title} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6]  focus:outline-none" placeholder="Enter title" onChange={handleChange} />
                                </div>
                                <div className="mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="mb-4">
                                        ...
                                        <input type="text" required pattern="\d{2}-\d{2}-\d{4}" id="releaseYear" name="releaseYear" value={formInput.releaseYear} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6] focus:border-blue-500 focus:outline-none" placeholder="Enter release year" onChange={handleChange} />
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="runningTime" className="block mb-2 text-white">Running Time (min)</label>
                                        <input type="text" required pattern="\d[0-9]{1,}" id="runningTime" name="runningTime" value={formInput.runningTime} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6] focus:border-blue-500 focus:outline-none" placeholder="Enter running time" onChange={handleChange} />
                                    </div>
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="quality" className="block mb-2 text-white">Quality</label>
                                    <select id="quality" required name="quality" value={formInput.quality} className="validInput w-full p-2 rounded bg-[#151f30] text-white focus:border-blue-500 focus:outline-none" onChange={handleChange}>
                                        <option>HD</option>
                        ...
                        <Col lg={12}>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="mb-4">
                                    ...
                                    <input type="text" pattern="\d[0-9]{1,}" id="age" name="age" value={formInput.age} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6] focus:border-blue-500 focus:outline-none" placeholder="Enter age" onChange={handleChange} />
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="country" className="block mb-2 text-white">Country</label>
                                    <input type="text" required pattern="[A-Za-z ]{2,}" id="country" name="country" value={formInput.country} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6] focus:border-blue-500 focus:outline-none" placeholder="Enter country" onChange={handleChange} />
                                </div>
                            </div>
                            <div className="mb-4">
                                <label htmlFor="genre" className="block mb-2 text-white">Genre</label>
                                <input type="text" required pattern="[A-Za-z ]{2,}" id="genre" name="genre" value={formInput.genre} className="validInput w-full p-2 rounded bg-[#151f30] text-white placeholder-[#b1a6a6] focus:border-blue-500 focus:outline-none" placeholder="Enter genre" onChange={handleChange} />
                            </div>
                            <div className="mb-4">
                                ...
                                <div className="flex items-center space-x-6">
                                    <label htmlFor="movie" className="flex items-center cursor-pointer">
                                        <input type="radio" id="movie" name="itemType" value="movie" required checked={formInput.itemType === 'movie'} className="hidden peer" onChange={handleChange} />
                                    ...
                                    <label htmlFor="tvshow" className="flex items-center cursor-pointer">
                                        <input type="radio" id="tvshow" name="itemType" value="tvshow" required checked={formInput.itemType === 'tvshow'} className="hidden peer" onChange={handleChange} />
                                        <div className="w-5 h-5 mr-3 border-2 bg-[#151f30] peer-checked:bg-[#909eb5] rounded-full peer-checked:border-blue-500 transition"></div>
